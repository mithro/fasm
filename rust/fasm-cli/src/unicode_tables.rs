...
//! tool runs with (Python 3.11.15, Unicode 14.0.0).
//!
...
/// `str.isprintable()` is false (sorted, disjoint).
pub const NON_PRINTABLE: &[(u32, u32)] = &[
    (0x0080, 0x00A0),
    (0x00AD, 0x00AD),
    (0x0378, 0x0379),
    (0x0380, 0x0383),
...
/// (decimal digit) code points `0`..=`9` (sorted); these are also
/// exactly the characters with a decimal value.
pub const DECIMAL_ZEROS: &[u32] = &[
