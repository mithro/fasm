...
//! `xcframes2bit` command line tool: a drop-in replacement for
//! prjuray-tools' C++ `xcframes2bit` (`.frm` frames -> `.bit` bitstream,
//! Series7, UltraScale and UltraScale+); see [`fasm_cli::xc7frames2bit`].
