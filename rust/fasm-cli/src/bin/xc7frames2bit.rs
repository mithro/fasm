...
//! `xc7frames2bit` command line tool: a drop-in replacement for prjxray's
//! C++ `xc7frames2bit` (`.frm` frames -> `.bit` bitstream, Series7); see
//! [`fasm_cli::xc7frames2bit`].
...
use fasm_cli::xc7frames2bit::{run, Env, ABORT};
