# litex_demo_picorv32 / arty_35 -- f4pga (VPR) flow FASM (T7.3)
...
the flow's extra FASM appended. The frames are not committed (248548 bytes after xz, over the 65536 byte limit of this corpus); their sha256 is below.

## Target

* Part: `xc7a35tcsg324-1` (family `artix7`), VPR device `xc7a50t_test`
* Build command (in f4pga-examples' `xc7/`): `cd litex_demo && ./src/litex/litex/boards/targets/arty.py --toolchain=symbiflow --cpu-type=picorv32 --sys-clk-freq 80e6 --output-dir build/picorv32/arty_35 --variant a7-35 --build`
* Build time on this machine (4 cores, one build at a time): 413 s
* FASM: 220114 lines, 8877596 bytes
...
```
sha256  top.fasm  a499e1f3238d7ae6edff137005aa875e9f2d90803ec2745986683c0e45f442a4
sha256  top.frm   f703e8d33e197bd3fca648b49e65a93ae0e6950864debd8146168719f9730b4a  (3967392 bytes)
sha256  top.bit   aa069bc8f15c46de72a5404ba105ab604ca6f8b8c762585815ff9232183db170  (2192119 bytes)
```
