# linux_litex_demo / arty_100 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm.xz` is the FASM of f4pga-examples' `linux_litex_demo` for the
Digilent Arty A7-100T (`arty_100`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh linux_litex_demo
...
the flow's extra FASM appended. The frames are not committed (362712 bytes after xz, over the 65536 byte limit of this corpus); their sha256 is below.

## Target

* Part: `xc7a100tcsg324-1` (family `artix7`), VPR device `xc7a100t_test`
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_100" make -C linux_litex_demo`
* Build time on this machine (4 cores, one build at a time): 664 s
* FASM: 340958 lines, 14454734 bytes
...
```
sha256  top.fasm  e5a0af2c7ae4c4174b4288e8c30971fa13d8497659dc34f705230a3e527b8f73
sha256  top.frm   782d6f343c0657a44236262116e6b130c04ddd85cf76ccbb86da9b4dea1e15e7  (5271156 bytes)
sha256  top.bit   3e467a9664a5ec8211232c9908a5ae042d64981472c6b12f5add6cbbfe854184  (3825896 bytes)
```
