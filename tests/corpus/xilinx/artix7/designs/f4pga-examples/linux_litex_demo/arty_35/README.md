# linux_litex_demo / arty_35 -- f4pga (VPR) flow FASM (T7.3)
...
the flow's extra FASM appended. The frames are not committed (364700 bytes after xz, over the 65536 byte limit of this corpus); their sha256 is below.

## Target

* Part: `xc7a35tcsg324-1` (family `artix7`), VPR device `xc7a50t_test`
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_35" make -C linux_litex_demo`
* Build time on this machine (4 cores, one build at a time): 634 s
* FASM: 344230 lines, 14465862 bytes
...
```
sha256  top.fasm  13abe03e42717292dfcbb299ed8f036c3078f813ae07c2b73d5f4ad5ff4bee62
sha256  top.frm   0ace2fad734897cfbeadaa9fb35a5298271fe77a8643c49ed0a4445e5d8dc267  (4409460 bytes)
sha256  top.bit   d47ad72d7b64ecf274e72310f3405990358ff77f2b5a8772d1adf24811336444  (2192119 bytes)
```
