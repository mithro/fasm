# hello_e / arty_35 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm` is the FASM of f4pga-examples' `hello_e` for the
Digilent Arty A7-35T (`arty_35`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh hello_e
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_35" make -C ../projf-makefiles/hello/hello-arty/E`
* Build time on this machine (4 cores, one build at a time): 63 s
* FASM: 760 lines, 31007 bytes
...
```
sha256  top.fasm  e513fb2f68de44bff680911f9a0e2256b95f3eb75a305e311fb3531ceca23826
sha256  top.frm   c74df208f38597fac4ff87331f5a96fc87c3aad17d9ef26abb5511b5e5a08dc0  (197472 bytes)
sha256  top.bit   59ad9d61761ececf1efdf52e5faaa63441a235489f3ffce3bdf272b65bf2800b  (2192119 bytes)
```
