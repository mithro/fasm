# button_controller / basys3 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm` is the FASM of f4pga-examples' `button_controller` for the
Digilent Basys 3 (`basys3`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh button_controller
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="basys3" make -C additional_examples/button_controller`
* Build time on this machine (4 cores, one build at a time): 72 s
* FASM: 2997 lines, 116440 bytes
...
```
sha256  top.fasm  48baf9afd579c24b010a6e88caa0d17a10f48f80b17c17ee37b697ce9babc92e
sha256  top.frm   e5c6dcec5b0cd6284e2977f3efa061f8d112222f247d2d59b03deae6859a6637  (1292544 bytes)
sha256  top.bit   0288efe4c694a7caa585391b932940d5938f57038c734d53350de3f47d5e231b  (2192119 bytes)
```
