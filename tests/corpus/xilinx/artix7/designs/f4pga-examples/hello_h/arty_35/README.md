# hello_h / arty_35 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm` is the FASM of f4pga-examples' `hello_h` for the
Digilent Arty A7-35T (`arty_35`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh hello_h
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_35" make -C ../projf-makefiles/hello/hello-arty/H`
* Build time on this machine (4 cores, one build at a time): 60 s
* FASM: 457 lines, 18841 bytes
...
```
sha256  top.fasm  1854b4dfc85f06cd614279b2d7629e114904d7e4aee19aad1e417e0e47c0037c
sha256  top.frm   44ad97634a052c506335ff5434f09301832da3ce69523359b7b3b82e2cd45a40  (991848 bytes)
sha256  top.bit   f9ee7a28ca491f0d6ee7c13a05270815230736e692fa68baa3c61d2dd7aa8899  (2192119 bytes)
```
