# hello_j / arty_35 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm` is the FASM of f4pga-examples' `hello_j` for the
Digilent Arty A7-35T (`arty_35`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh hello_j
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_35" make -C ../projf-makefiles/hello/hello-arty/J`
* Build time on this machine (4 cores, one build at a time): 61 s
* FASM: 806 lines, 35591 bytes
...
```
sha256  top.fasm  3f46f10193f7691cd1c304dec497c0cc3554e42bc3d64c6e5fc2389ed960dd85
sha256  top.frm   2874b6aba59e75a450f2783d88bd81b2730df06a365ee98c86cd41b1d1eeeba9  (269280 bytes)
sha256  top.bit   5fb734e92cefefccadd599f989852b3e22af252ea1c3c05a43a7982f84594e25  (2192119 bytes)
```
