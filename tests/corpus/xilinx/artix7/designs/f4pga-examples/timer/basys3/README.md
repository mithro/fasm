# timer / basys3 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm` is the FASM of f4pga-examples' `timer` for the
Digilent Basys 3 (`basys3`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh timer
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="basys3" make -C timer`
* Build time on this machine (4 cores, one build at a time): 72 s
* FASM: 2970 lines, 116770 bytes
...
```
sha256  top.fasm  765874e80c4bb5c1b88da3d67fb3919b8b79d7d0648cc4ed4a5318e73b9a5e03
sha256  top.frm   05248373a32b379b2cf18f0d2cba9a7d35f01cfca31a91c065da0a10337cc9d6  (1543872 bytes)
sha256  top.bit   50a90c1bbe7ba6ef36c535c86fb6cb28ef022d19e4bd2193c687482088962c8b  (2192119 bytes)
```
