# hello_f / arty_35 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm` is the FASM of f4pga-examples' `hello_f` for the
Digilent Arty A7-35T (`arty_35`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh hello_f
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_35" make -C ../projf-makefiles/hello/hello-arty/F`
* Build time on this machine (4 cores, one build at a time): 61 s
* FASM: 856 lines, 34692 bytes
...
```
sha256  top.fasm  4160cf12957cca5ebf2988ac1e9623240b8c15aea8cf1996cae138133326425e
sha256  top.frm   9a9a186d48e70039835561c59a596be84d3112abba45d50033f055539a99ca59  (1126488 bytes)
sha256  top.bit   cf88e7b5467d2e5b49c57724f0dc73e1abc636caf15f4073f9824b747c65d7b0  (2192119 bytes)
```
