# hello_c / arty_35 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm` is the FASM of f4pga-examples' `hello_c` for the
Digilent Arty A7-35T (`arty_35`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh hello_c
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_35" make -C ../projf-makefiles/hello/hello-arty/C`
* Build time on this machine (4 cores, one build at a time): 64 s
* FASM: 209 lines, 9546 bytes
...
```
sha256  top.fasm  8a4e2c396c91c5b1bec340b6c86f7f66f07296a29ca2071410b770e1af5d66a7
sha256  top.frm   e77b69ec7e3aa532fe0a8581b84fdce91342dbb281c9b65b98654a8741b94f6f  (675444 bytes)
sha256  top.bit   21cb5d136dda1425b8f3215b531bc5002b03fcf1d3e22df65e948fb826236b72  (2192119 bytes)
```
