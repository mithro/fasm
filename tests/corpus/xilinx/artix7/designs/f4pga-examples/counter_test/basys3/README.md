# counter_test / basys3 -- f4pga (VPR) flow FASM (T7.3)
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="basys3" make -C counter_test`
* Build time on this machine (4 cores, one build at a time): 70 s
* FASM: 782 lines, 31791 bytes
...
```
sha256  top.fasm  4c5bf1f3b5e522e72ed49a0bb9946f6cd192a005ddbf763a7f7a4ea89c68564c
sha256  top.frm   ffbc4afb49fa56f54eb83fbafbc00aa0c649a00b4aa7cd4b0d0d9b49571ed45a  (486948 bytes)
sha256  top.bit   37617bfe8b6aba27f90d57d20a5f3db3575e17cc1f45c05ca019afeab6d59633  (2192119 bytes)
```
