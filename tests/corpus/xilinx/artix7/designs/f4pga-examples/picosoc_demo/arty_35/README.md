# picosoc_demo / arty_35 -- f4pga (VPR) flow FASM (T7.3)
...
the flow's extra FASM appended. The frames are not committed (112084 bytes after xz, over the 65536 byte limit of this corpus); their sha256 is below.

## Target

* Part: `xc7a35tcsg324-1` (family `artix7`), VPR device `xc7a50t_test`
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_35" make -C picosoc_demo`
* Build time on this machine (4 cores, one build at a time): 232 s
* FASM: 97441 lines, 3619631 bytes
...
```
sha256  top.fasm  70d6e07cadca6f0876bd90587005ebadd2fd205b5d0170f5908f6ed7a16c074a
sha256  top.frm   c51c3851dd73ad2b3b21b13b3acb6f1101dfc29ea61ad0e29a8513dfa0e63450  (3161796 bytes)
sha256  top.bit   56ad15dd74dee122fd1f172cc9d2f761b0d9c10f9d46fd0ec447b21332b8ccda  (2192119 bytes)
```
