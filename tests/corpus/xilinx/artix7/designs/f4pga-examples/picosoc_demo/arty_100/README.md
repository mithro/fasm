# picosoc_demo / arty_100 -- f4pga (VPR) flow FASM (T7.3)
...
the flow's extra FASM appended. The frames are not committed (110284 bytes after xz, over the 65536 byte limit of this corpus); their sha256 is below.

## Target

* Part: `xc7a100tcsg324-1` (family `artix7`), VPR device `xc7a100t_test`
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_100" make -C picosoc_demo`
* Build time on this machine (4 cores, one build at a time): 283 s
* FASM: 96951 lines, 3666909 bytes
...
```
sha256  top.fasm  5bb396c2c761bf9bfd6736eceb89fdc78ce9ed9df210bbde7fdb8ff96623078a
sha256  top.frm   860f9fec66e4c5c18fefd6870ef5a5bd51fe57f91321de974d7faefe1214e57e  (2535720 bytes)
sha256  top.bit   89194b19a967ba3650adcf22b4295a82774f582fb4e222e4ba549b7d4e8b73a2  (3825896 bytes)
```
