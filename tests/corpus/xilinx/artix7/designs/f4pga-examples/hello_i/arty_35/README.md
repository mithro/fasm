# hello_i / arty_35 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm` is the FASM of f4pga-examples' `hello_i` for the
Digilent Arty A7-35T (`arty_35`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh hello_i
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_35" make -C ../projf-makefiles/hello/hello-arty/I`
* Build time on this machine (4 cores, one build at a time): 62 s
* FASM: 1060 lines, 41743 bytes
...
```
sha256  top.fasm  89814c09f3237f006e2f7aa5c38255c2c8dd094809916c122c7ca775c6ec7f90
sha256  top.frm   17e9e4b920c8e7157c086a397ade53f55d654ed0d0e669d843e0ac8284cba8b0  (1310496 bytes)
sha256  top.bit   5257ee0c6ab00ec43d692341f93909c0db6ae0cf8a82e937ddf310ebf23fd252  (2192119 bytes)
```
