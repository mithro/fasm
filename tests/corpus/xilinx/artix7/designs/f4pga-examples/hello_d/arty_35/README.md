# hello_d / arty_35 -- f4pga (VPR) flow FASM (T7.3)

`vpr.fasm` is the FASM of f4pga-examples' `hello_d` for the
Digilent Arty A7-35T (`arty_35`), built with the f4pga Yosys + VPR flow exactly as
f4pga-examples documents it, by `tools/e2e/run-f4pga-examples.sh hello_d
...
* Build command (in f4pga-examples' `xc7/`): `TARGET="arty_35" make -C ../projf-makefiles/hello/hello-arty/D`
* Build time on this machine (4 cores, one build at a time): 61 s
* FASM: 255 lines, 11535 bytes
...
```
sha256  top.fasm  b94380b157592c4db4ca87380b0ada1fa696cd401b694dc3b813f8000f9cbbd0
sha256  top.frm   3d6e122f4421f09f2b70152e35b67e79eff66f6fc7d45ba805b574dba6fe0c2c  (778668 bytes)
sha256  top.bit   0b08f92d696b1dcf4ad5791f4a67598d2f45a0f9a25a4a2bb05013782bc86167  (2192119 bytes)
```
