# openxc7-primitive-tests/mmcm-blinky-artixx/xc7a100tfgg676 -- nextpnr-xilinx (openXC7) FASM (T7.6)

`top.fasm` is the FASM nextpnr-xilinx wrote for openXC7 primitive-tests `mmcm-blinky-artixx` ([source](https://github.com/openXC7/primitive-tests/tree/d29ee7c58bdad361c690298d0c1b22004f9f4c02/mmcm-blinky-artixx), commit `d29ee7c58bdad361c690298d0c1b22004f9f4c02`), built by `tools/e2e/run-nextpnr-examples.sh openxc7-primitive-tests/mmcm-blinky-artixx/xc7a100tfgg676` following the example's own Makefile (see `tools/e2e/README.md`, "nextpnr-xilinx examples corpus (T7.6)"). `top.frm.xz` is the flow's frames: the snap's `fasm2frames`, dense, with the snap's prjxray-db.
...
* Flow times on this machine (4 cores, s): buf_fix 0.7, fasm2frames 1.14, pnr 5.92, synth 3.04, xc7frames2bit 0.12
...
sha256  top.bit   affc7a8230954c3becca8bfbd31ae51f67bda9f4aab8ffda511860450ffc08c8  (3825893 bytes; header with the build time)
```
