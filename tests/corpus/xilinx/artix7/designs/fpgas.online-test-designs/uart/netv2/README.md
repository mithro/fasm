# uart / netv2 -- fpgas.online-test-designs FASM (T7.2)
...
tools/e2e/install-fpgas-online-corpus.sh uart netv2
```
...
* Board: `netv2`
* Gateware script: `designs/uart/gateware/uart_soc_netv2.py`
...
# commands are in the generated designs/uart/build/netv2/build_top.sh
...
CHIPDB=<chipdb overlay dir> PRJXRAY_DB_DIR=<prjxray-db root> \
  ...
  tools/e2e/build/fpgas.online-test-designs/designs/uart/gateware/uart_soc_netv2.py \
...
```
sha256  top.fasm (uncompressed)   730ff89eb519dbc82a20a6ea48f9b500dcb36356f7cc21f4791ea4d6be872b42
sha256  top.frm (uncompressed)    5c70352a2520de227e2990d40d5a349e667307a603284ae6a02194e5de731ff8
sha256  top.bit (not committed)   e5b93c016a35e9fa174f64883d1c7203fb3077ffd41fc29757ca7772595d9f8f
```

top.fasm: 86529 lines / 3408970 bytes uncompressed, 327592 bytes as top.fasm.xz
top.frm: 5580828 bytes uncompressed, 95880 bytes as top.frm.xz
top.sparse.frm: 91700 bytes as top.sparse.frm.xz
top.bit: 2192212 bytes (not committed; regenerate to verify)

## Timings (this machine, this run)

* LiteX build (synth + PnR + FASM): 83s
* fasm2frames (dense): 2s
* fasm2frames (sparse): 3s
* xc7frames2bit: 0s
