# ddr-memory / arty -- fpgas.online-test-designs FASM (T7.2)
...
tools/e2e/run-fpgas-online.sh ddr-memory arty
tools/e2e/install-fpgas-online-corpus.sh ddr-memory arty
```
...
* Board: `arty`
* Gateware script: `designs/ddr-memory/gateware/ddr_soc_arty.py`
...
# commands are in the generated designs/ddr-memory/build/arty/build_top.sh
...
CHIPDB=tools/e2e/build/chipdb-overlay PRJXRAY_DB_DIR=tools/e2e/build/openxc7/root/opt/nextpnr-xilinx/external/prjxray-db \
  ...
  tools/e2e/build/fpgas.online-test-designs/designs/ddr-memory/gateware/ddr_soc_arty.py \
...
```
sha256  top.fasm (uncompressed)   bdaa4cafec15ebd610827d9f671565dec32e7e820df986fa7f7c2cdac7561cc6
sha256  top.frm (uncompressed)    0d786694583e5ed295471595e65718bee0df4cc1f2a9d8dd44d1038a3e8bd7ab
sha256  top.bit (not committed)   ccd5f2804557f5468f76f454548f5749ac86685410127cd00417678fa78fc7e1
```

top.fasm: 189674 lines / 7229775 bytes uncompressed, 712528 bytes as top.fasm.xz
top.frm: 5580828 bytes uncompressed, 220588 bytes as top.frm.xz
top.sparse.frm: 218516 bytes as top.sparse.frm.xz
top.bit: 2192217 bytes (not committed; regenerate to verify)

## Timings (this machine, this run)

* LiteX build (synth + PnR + FASM): 145s
