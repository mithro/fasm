# single_wire / arty_35 -- VTR genfasm FASM (T7.4)

`genfasm.fasm` is the FASM of VTR's Verilog benchmark `single_wire`
(`vtr_flow/benchmarks/verilog/single_wire.v`, top module `top`) built with
the f4pga flow for the Digilent Arty A7-35T on the f4pga toolchain's `xc7a50t_test`
architecture, by `tools/e2e/run-vtr-genfasm.sh verilog single_wire` (see
...
```
sha256  top.fasm  17fbc3b059f1d70f4e323f75b93d8e53f89ffdb68ac9a44302034e95fd3f01a1
sha256  top.frm   1f0fefcdc640c571c75bdcc207f1f1f059696ebf50d794582076d2acb8901d2d  (94248 bytes)
sha256  top.bit   5f21ff867913003a09c212bc686b68e6df79f79486fb35dde1ce9698ed9e32fb  (2192229 bytes)
```
