# multiclock_output_and_latch / arty_35 -- VTR genfasm FASM (T7.4)

`genfasm.fasm` is the FASM of VTR's Verilog benchmark `multiclock_output_and_latch`
(`vtr_flow/benchmarks/verilog/multiclock_output_and_latch.v`, top module `multiclock_output_and_latch`) built with
the f4pga flow for the Digilent Arty A7-35T on the f4pga toolchain's `xc7a50t_test`
architecture, by `tools/e2e/run-vtr-genfasm.sh verilog multiclock_output_and_latch` (see
...
* FASM: 265 lines, 11825 bytes

## Source and licence

* Design: VTR `vtr_flow/benchmarks/verilog/multiclock_output_and_latch.v`, one of VTR's small test designs.
...
```
sha256  top.fasm  a7a507ccf0918276c4d9fe1f9e3f0cb702640e380a20964518f52b2194541686
sha256  top.frm   9ff6af475b8f12bb8c8e8ede8ab97ed5063f2eb59758a4cfb3659a957e13d78a  (850476 bytes)
sha256  top.bit   4b1ba1f70a40b4f06c14dce69f6eb4f7d986c2c1c3d58abdac5237d01086ccf7  (2192245 bytes)
```
