# minilitex_ddr_arty / arty_35 -- VTR genfasm FASM (T7.4)

`genfasm.fasm.xz` is the FASM VTR's `genfasm` writes for the `minilitex_ddr_arty`
...
xc7a50t_test minilitex_ddr_arty` (see `tools/e2e/README.md`, "VTR genfasm
designs (T7.4)"): VPR packs, places and routes the benchmark's eblif
with the task's options, then genfasm writes the FASM. The reference frames are not committed (285124 bytes after xz, over the 65536 byte limit of this corpus); their sha256 is below.
...
* Netlist, SDC and placement constraints:
  `benchmarks/circuits/minilitex_ddr_arty.eblif`, `benchmarks/sdc/minilitex_ddr_arty.sdc`,
  `benchmarks/place_constr/minilitex_ddr_arty.place`
...
* VPR: `vpr arch.timing.xml minilitex_ddr_arty.eblif --read_rr_graph
  ...
  rr_graph_xc7a50t_test.place_delay.bin --sdc_file minilitex_ddr_arty.sdc
  --fix_clusters minilitex_ddr_arty.place`, 391 s
* genfasm: `genfasm arch.timing.xml minilitex_ddr_arty.eblif --read_rr_graph
  rr_graph_xc7a50t_test.rr_graph.real.bin <options>`, 31.6 s
...
```
sha256  top.fasm  d2700a96dbd0f5133480a3180b697e27aed650c60385c98ada1f3d70fa267752
sha256  top.frm   0068d92e1d09248b845079f62ad62b16ccd4184b1fff5d9e87fe64b25b43d95f  (4404972 bytes)
sha256  top.bit   fed312f6adc8ec8d2f871dd1f1414741b0f6074c5ddc246ad3c03ca247a23fa8  (2192236 bytes)
```
