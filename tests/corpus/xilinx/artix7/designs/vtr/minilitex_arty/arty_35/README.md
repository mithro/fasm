# minilitex_arty / arty_35 -- VTR genfasm FASM (T7.4)

`genfasm.fasm.xz` is the FASM VTR's `genfasm` writes for the `minilitex_arty`
...
xc7a50t_test minilitex_arty` (see `tools/e2e/README.md`, "VTR genfasm
designs (T7.4)"): VPR packs, places and routes the benchmark's eblif
with the task's options, then genfasm writes the FASM. The reference frames are not committed (182880 bytes after xz, over the 65536 byte limit of this corpus); their sha256 is below.
...
* Netlist, SDC and placement constraints:
  `benchmarks/circuits/minilitex_arty.eblif`, `benchmarks/sdc/minilitex_arty.sdc`,
  `benchmarks/place_constr/minilitex_arty.place`
...
* VPR: `vpr arch.timing.xml minilitex_arty.eblif --read_rr_graph
  ...
  rr_graph_xc7a50t_test.place_delay.bin --sdc_file minilitex_arty.sdc
  --fix_clusters minilitex_arty.place`, 268 s
* genfasm: `genfasm arch.timing.xml minilitex_arty.eblif --read_rr_graph
  rr_graph_xc7a50t_test.rr_graph.real.bin <options>`, 30.4 s
...
* FASM: 153885 lines, 6627706 bytes

## Source and licence

* Design: symbiflow-arch-defs `xc/xc7/tests/soc/litex/mini/`: a LiteX generated SoC (`gateware/top.v`) with the VexRiscv CPU of litex-hub/pythondata-cpu-vexriscv (`VexRiscv.v`).
...
```
sha256  top.fasm  c70e1ab567803e67c21fc79c2405665d4707b7fef0b43813276fb796e48b0212
sha256  top.frm   accdf4caee6b9857cfbc532068557d04cc74a7edfe2a426a8596a4f0f6eca7dd  (3628548 bytes)
sha256  top.bit   8d6d1cf3bc137a600f0bebc4f90be51d9ec98d845743d2f4c1f9b2d3bb7c2a92  (2192232 bytes)
```
